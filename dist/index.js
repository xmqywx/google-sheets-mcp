...
// Spreadsheet Tools
// ══════════════════════════════════════════════════════════
server.tool("list_spreadsheets", "List recent spreadsheets from Google Drive (requires service account)", {
...
server.tool("get_spreadsheet", "Get spreadsheet metadata including title, sheets, and locale", {
...
// Sheet/Tab Tools
// ══════════════════════════════════════════════════════════
server.tool("list_sheets", "List all sheets/tabs in a spreadsheet", {
    spreadsheetId: z.string().describe("The ID of the spreadsheet"),
}, async ({ spreadsheetId }) => {
    try {
...
server.tool("add_sheet", "Add a new sheet/tab to a spreadsheet", {
    spreadsheetId: z.string().describe("The ID of the spreadsheet"),
...
server.tool("delete_sheet", "Delete a sheet/tab from a spreadsheet", {
    spreadsheetId: z.string().describe("The ID of the spreadsheet"),
    ...
    try {
        ...
        return {
            content: [{ type: "text", text: `Sheet ${sheetId} deleted successfully.` }],
        };
    }
    catch (error) {
        const message = error instanceof Error ? error.message : String(error);
...
// Data Tools
// ══════════════════════════════════════════════════════════
server.tool("read_range", "Read cells from a range (e.g., 'Sheet1!A1:D10')", {
    spreadsheetId: z.string().describe("The ID of the spreadsheet"),
...
server.tool("write_range", "Write data to a range in a spreadsheet", {
    spreadsheetId: z.string().describe("The ID of the spreadsheet"),
...
server.tool("append_rows", "Append rows to the end of a sheet", {
    spreadsheetId: z.string().describe("The ID of the spreadsheet"),
...
server.tool("clear_range", "Clear all values from a range of cells", {
    spreadsheetId: z.string().describe("The ID of the spreadsheet"),
    ...
    try {
        ...
        return {
            content: [{ type: "text", text: `Range ${range} cleared successfully.` }],
        };
    }
    catch (error) {
        const message = error instanceof Error ? error.message : String(error);
...
server.tool("get_values", "Get all values from a sheet", {
    spreadsheetId: z.string().describe("The ID of the spreadsheet"),
...
// Formatting Tools
// ══════════════════════════════════════════════════════════
server.tool("format_cells", "Apply formatting to a range of cells (bold, color, number format, alignment)", {
    spreadsheetId: z.string().describe("The ID of the spreadsheet"),
...
}, async ({ spreadsheetId, sheetId, startRow, endRow, startCol, endCol, bold, italic, fontSize, foregroundColor, backgroundColor, numberFormat, horizontalAlignment, }) => {
    try {
        ...
        return {
            content: [{ type: "text", text: "Formatting applied successfully." }],
        };
    }
    catch (error) {
        const message = error instanceof Error ? error.message : String(error);
...
// Utility Tools
// ══════════════════════════════════════════════════════════
server.tool("search_sheets", "Search for text across all sheets in a spreadsheet", {
    spreadsheetId: z.string().describe("The ID of the spreadsheet"),
...
server.tool("sheet_overview", "Get an overview of a sheet with row/column counts and sample data", {
    spreadsheetId: z.string().describe("The ID of the spreadsheet"),
